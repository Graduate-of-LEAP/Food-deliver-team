...
export const Address: React.FC = () => {
    ...
    const allFieldsFilled = (): boolean => {
        return district !== "" && khoro !== "" && building !== "" && phone.length >= 8;
    };
            ...
            <div className='px-8 w-fit'>
                ...
                <div className='border-2 rounded-lg p-8 flex flex-col gap-8 shadow-lg'>
                    ...
                    <Select onValueChange={setDistrict} value={district}>
                        <SelectTrigger className={`${district ? 'bg-green-500 text-white' : 'bg-gray-100'} w-[300px]`}>
                        ...
                        <SelectContent>
                            <SelectGroup>
                                {["Баянзүрх", "Хан-Уул", "Баянгол", "Сонгинохайрхан", "Чингэлтэй"].map((value) => (
                                    <SelectItem
                                        key={value}
                                        value={value}
                                        className={district === value ? "bg-green-500 text-white" : "bg-white text-black"}
                                    >
                                        <div className='flex gap-2'><CiLocationOn size={18} /> {value} дүүрэг</div>
                                    </SelectItem>
                                ))}
                            </SelectGroup>
                        </SelectContent>
                    ...
                    <Select onValueChange={setKhoro} value={khoro}>
                        <SelectTrigger className={`${khoro ? 'bg-green-500 text-white' : 'bg-gray-100'} w-[300px]`}>
                            <SelectValue placeholder={
                                <div className="flex items-center">
                                    <CiLocationOn size={22} className="mr-4" />
                            ...
                            <SelectGroup>
                                {["1", "2", "3", "4", "5", "6", "7"].map((value) => (
                                    <SelectItem
                                        key={value}
                                        value={value}
                                        className={khoro === value ? "bg-green-500 text-white" : "bg-white text-black"}
                                    >
                                        <div className='flex gap-2'><CiLocationOn size={18} /> {value}-р хороо</div>
                                    </SelectItem>
                                ))}
                            </SelectGroup>
                        </SelectContent>
                    ...
                    <Select onValueChange={setBuilding} value={building}>
                        <SelectTrigger className={`${building ? 'bg-green-500 text-white' : 'bg-gray-100'} w-[300px]`}>
                            <SelectValue placeholder={
                                <div className="flex items-center">
                                    <CiLocationOn size={22} className="mr-4" />
                            ...
                            <SelectGroup>
                                {["Нархан хотхон", "Зайсан хотхон"].map((value) => (
                                    <SelectItem
                                        key={value}
                                        value={value}
                                        className={building === value ? "bg-green-500 text-white" : "bg-white text-black"}
                                    >
                                        <div className='flex gap-2'><CiLocationOn size={18} /> {value}</div>
                                    </SelectItem>
                                ))}
                            </SelectGroup>
                        </SelectContent>
            ...
            <div className='px-8'>
                ...
                <div className='border-2 rounded-lg p-4 flex flex-col gap-[24.2rem] shadow-lg'>
                    ...
                    <div className='flex justify-between'>
                        ...
                        <button
                            className={`w-1/2 rounded-sm text-white ${allFieldsFilled() && isPaymentSelected() ? 'bg-green-500' : 'bg-gray-100 text-gray-400'}`}
