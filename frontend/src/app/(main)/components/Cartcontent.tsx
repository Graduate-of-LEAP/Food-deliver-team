...
//                             <div className="mt-6">
//                                 {sags.map(sag => (
//                                     <div key={sag._id} className="flex border-t-2 border-b-2 py-2 justify-start items-start gap-4">
//                                         <div className="w-full h-[250px] p-2 relative flex-1 mt-2 gap-2">
//                                             <Image src={sag.foodId.images[0]} fill alt={sag.foodId.foodName} className="object-cover" />
//                                         </div>
//                                         <div className="w-1/2 flex flex-col gap-2 justify-between p-2">
//                                             <div>
//                                                 <div className="text-2xl flex items-center justify-between">
...
//                                                     </button>
//                                                 </div>
//                                                 <b className="text-green-500 text-lg font-bold">{sag.price} ₮</b>
//                                             </div>
//                                             <div>
//                                                 <b className="text-lg">Орц</b>
//                                                 <p className="p-2 bg-gray-50 rounded-lg my-2">{sag.foodId.orts}</p>
//                                             </div>
//                                             <div>
//                                                 <b className="text-lg">Тоо</b>
