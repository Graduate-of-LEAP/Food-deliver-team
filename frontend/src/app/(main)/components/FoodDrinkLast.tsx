...
export const FoodDrinkLast = () => {
  ...
  return (
    <>
      <div className="flex text-gray-800 font-bold text-2xl pl-6">Уух зүйл</div>
          ...
          <Dialog key={index} open={dialogOpen} onOpenChange={setDialogOpen}>
            <DialogTrigger asChild>
              <div
                ...
                onClick={() => {
                  setCurrentItem(item);
                  setDialogOpen(true); // Open the dialog after setting the current item
                }}
              >
                <FoodDiscountCard
                  src={item.images[0]}
