        ...
        <div className="flex justify-center">
          <div className="container flex justify-center">
            <div className="w-full px-8 py-28">
              ...
              <div className="flex flex-col md:flex-row justify-between  mt-12 z-10">
                {footer.map((item, index) => (
                    <div key={index} onClick={() => router.push(item.href)} className=" relative z-20">
                      <p className="text-white font-semibold border-b  text-base">{item.title}</p>
                    </div>
                ))}
              </div>
              <div className="flex gap-4 justify-center mt-10">
                <FaFacebook className="social-icon text-white text-4xl hover:text-gray-300" aria-label="Facebook" />
                <FaInstagram className="social-icon text-white text-4xl hover:text-gray-300" aria-label="Instagram" />
                <FaTwitter className="social-icon text-white text-4xl hover:text-gray-300" aria-label="Twitter" />
              </div>
