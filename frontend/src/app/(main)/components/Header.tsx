        ...
        <div className="flex items-center gap-4 lg:visible invisible">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className="bg-transparent  w-[260px] px-10 border-gray-100 rounded-xl outline-none shadow-md"
            ></Input>
          </div>
          <div className="relative w-7 h-7 flex mb-2">
            <div className="absolute top-0 right-0 bg-blue-500 text-white rounded-full h-4 w-4 flex justify-center items-center text-xs z-1000">
              0
            </div>{" "}
            <FaRegHeart className="absolute bottom-0 left-0 -z-40" size={18} />
          </div>
          {/* <Sheet>
        ...
        <div className="flex border-t-2 border-b-2 py-2 items-center">
          ...
          <Sheet>
            <SheetTrigger asChild>
              <Button
                variant="outline"
                className="flex gap-2 items-center px-4 font-semibold  border-none"
              >
                <MdOutlineShoppingBasket />
                <p>Сагс</p>
              </Button>
            ...
            <SheetContent className="w-fit  ">
              <div className="w-full flex items-center mb-3 ">
                <FaAngleLeft className="flex" />
                <div className="flex w-full items-center font-bold justify-center">
                  {" "}
                  Таны сагс
                </div>
              </div>
              <div className="flex  flex-col justify-between h-[95%]">
                ...
                <div className="w-full  flex h-fit">
                  ...
                  <div className="w-full flex ">
                    <div className="w-full flex ">
                      <Button className="w-full  py-6  rounded-xl bg-[#18BA51] hover:bg-[#18BA51]">
                        Захиалах
                      </Button>
                    </div>
                  </div>
          ...
          <div className="flex items-center px-4 font-semibold relative">
